...
import com.cheyifu.business.dialog.IosDialog.res.drawable.ProgressDrawable;
...
class BodyProgressView extends ScaleLinearLayout {
    ...
    private void init(Context context, CircleParams params) {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, mProgressParams.progressHeight);
