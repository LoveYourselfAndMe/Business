...
public class HTLoadBlock {

	private static HTCustomProgress dialog;
	private static Context context;
	private static SimpleHUDCallback callback;

	public static int dismissDelay = HTLoadBlock.DISMISS_DELAY_SHORT;
	...
	private static void setDialog(Context ctx, String msg,
		...
		if (!isContextValid())
			return;
		// 返回dialog对象
		dialog = HTCustomProgress.createDialog(ctx);
